...
static void copyConvertStringLiteralIntoUTF16(const wchar_t * inputString, A_UTF16Char * destination)
{
#ifdef AE_OS_MAC
	...
	AEGP_GlobalRefcon		*global_refconP)	/* << */
{
	...
	AnimatorPluginInitiator::initialize(pica_basicP, major_versionL, minor_versionL, aegp_plugin_id, global_refconP);
